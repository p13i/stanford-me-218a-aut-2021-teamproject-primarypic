...
#include "../ProjectHeaders/RadioCodeTaskSM.h"
...
static RadioCodeTaskState_t CurrentState;
...
/****************************************************************************
 Function
     QueryRadioCodeTaskSM

 Parameters
     None

 Returns
     RadioCodeTaskState_t The current state of the Template state machine
