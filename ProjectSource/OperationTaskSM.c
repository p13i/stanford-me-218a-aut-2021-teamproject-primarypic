...
#include "../ProjectHeaders/OperationTaskSM.h"
...
static OperationTaskState_t CurrentState;
...
/****************************************************************************
 Function
     QueryOperationTaskSM

 Parameters
     None

 Returns
     OperationTaskState_t The current state of the Template state machine
